...
const data = [
  {
    ...
    "icons": [
      ...
      {
        "name":"Codechef",
        "link": "https://www.codechef.com/users/aatma",
        "logo": <SiCodechef/>,
      },
      {
        "name":"Codeforces",
  ...
  },
  {
    ...
    "icons": [
      ...
      },
      {
        "name":"Solidworks",
        "link": "",
        "logo": <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
      ...
      <div className={classes.cards}>
        {
          data.map((item, key) => {
            return (
              <div key={key}>
                <SkillCard key={key} heading={item.skill} icons={item.icons} id={key}/>
                { key<data.length-1 ? <span className={classes.lineContainer}><hr className={key%2===0 ? classes.evenLine : classes.oddLine} /></span> : <></>}
              </div>
            )
          })
        }
